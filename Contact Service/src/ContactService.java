...
public class ContactService {
    ...
    /* this method adds a given contact to the list if its not already present */
    public boolean add(Contact contact) {
        /* first its determined if the contact is already present */
        ...
        /* if the contact is not present then it is added, and returns true */
        if (!alreadyPresent) {
...
/* this method remove a contact with given contactId if present in the list */
